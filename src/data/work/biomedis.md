...
description: Biomedis est une entreprise de relation médecin-praticien, qui propose des visites chez les praticiens pour tester des médicaments. Cette application est composée d'une application web et de son API.
tags:
  - "Etudes"
  - "WEB : React Vite"
  - "API : AdonisJs"
...
Biomedis est une entreprise fictive pour laquelle j'ai créé une application lors de la dernière situation professionnelle de BTS SIO 2ème année.
...
Elle **vérifie** également la **présence** et la **validité** d'un **token** dans le **stockage local** afin de ne pas avoir à passer par cette étape.
...
Pour cela, on peut chercher le praticien voulu dans la barre de recherche et sélectionner "organiser une visite".
...
En dernier il faut indiquer quels échantillons de **médicaments** ont été fournis au praticien ainsi que leur **quantité**. 